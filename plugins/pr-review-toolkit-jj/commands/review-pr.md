...
1. **Determine Review Scope**
   - Check jj status to identify changed files
...
**Full review (default):**
```
/pr-review-toolkit-jj:review-pr
```

**Specific aspects:**
```
/pr-review-toolkit-jj:review-pr tests errors
# Reviews only test coverage and error handling

/pr-review-toolkit-jj:review-pr comments
# Reviews only code comments

/pr-review-toolkit-jj:review-pr simplify
# Simplifies code after passing review
```

**Parallel review:**
```
/pr-review-toolkit-jj:review-pr all parallel
...
```
1. Write code
2. Run: /pr-review-toolkit-jj:review-pr code errors
3. Fix any critical issues
4. Commit with jj commit
```

**Before creating PR:**
```
1. Review changes with jj diff
2. Run: /pr-review-toolkit-jj:review-pr all
...
4. Push updates with jj git push
```
